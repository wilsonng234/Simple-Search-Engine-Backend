...
2. Set up [application.properties](src/main/resources/application.properties)  
   Default value:  
   `spring.data.mongodb.database=${MONGO_DATABASE}`: the name of the database that will be created in MongoDBCompass  
   `spring.data.mongodb.uri=mongodb://localhost:27017/`: the Connection String URI as in the MongoDBCompass  
